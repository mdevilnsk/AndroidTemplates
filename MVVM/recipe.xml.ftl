...
<recipe>
    ...
    <instantiate from="src/app_package/mvvm_rx/ViewState.kt.ftl"
                   to="${escapeXmlAttribute(srcOut)}/${featureName}ViewState.kt" />
    ...
    <instantiate from="test/app_package/mvvm_rx/ViewModelTest.kt.ftl"
    		 to="${escapeXmlAttribute(unitTestOut)}/${featureName}ViewModelTest.kt" />

    <open file="${escapeXmlAttribute(resOut)}/layout/fragment_${classToResource(featureName)}.xml" />
    <open file="${escapeXmlAttribute(srcOut)}/${featureName}ViewState.kt" />
    <open file="${escapeXmlAttribute(srcOut)}/${featureName}Fragment.kt" />
    <open file="${escapeXmlAttribute(srcOut)}/${featureName}ViewModel.kt" />
    <open file="${escapeXmlAttribute(unitTestOut)}/${featureName}ViewModelTest.kt" />
</recipe>
